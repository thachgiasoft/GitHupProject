<%@ Page Title="" Language="C#" MasterPageFile="~/Page.Master" AutoEventWireup="true" CodeBehind="index2.aspx.cs" Inherits="WebApplication1.Users.index2" %>
    ...
    <div id="main">
        <div class="shell">
            ...
            <div class="col">
                ...
                <div class="cl">
                    &nbsp;</div>
                <a href="/Users/AnnounceList.aspx" class="find-more">查看更多</a>
            </div>
            <div class="col last">
                <h2>
                    留言版</h2>
