<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUser1.aspx.cs" Inherits="WebApplication1.Users.AddUser1" %>
...
<div class="dataEye">
	<div class="loginbox registbox">
		<div class="login-content reg-content">
			...
			<form id="signupForm" action="AddUser1.aspx" method="post" runat="server">
