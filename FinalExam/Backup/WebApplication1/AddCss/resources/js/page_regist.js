$(document).ready(function(){
	...
	var validate = $("#signupForm").validate({
		...
		messages: {
			User: {
				required: $.i18n.prop("请填写用户名"),
			},
			password: {
				required: $.i18n.prop("请填写密码"),
				minlength: jQuery.format($.i18n.prop("密码太短")),
				maxlength: jQuery.format($.i18n.prop("密码太长"))
			},
			passwordAgain: {
				required: $.i18n.prop("请填写密码"),
				minlength: jQuery.format($.i18n.prop("密码太短")),
				maxlength: jQuery.format($.i18n.prop("密码太长")),
				equalTo: jQuery.format($.i18n.prop("两次填写密码不一致"))
			},
			contact: {
				required: $.i18n.prop("请写手机号！")
			},
			company: {
			    required: $.i18n.prop("请填写邮箱"),
			    email: $.i18n.prop("请填写正确的邮箱名")
			},
			tel: {
