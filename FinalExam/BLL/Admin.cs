...
namespace shaoqi.BLL
{
    ...
    {
        private readonly shaoqi.DAL.Admin dal = new shaoqi.DAL.Admin();
        public Admin()
        { }
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public shaoqi.Model.Admin GetModelByCache(int Id)
        {
            ...
            return (shaoqi.Model.Admin)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<shaoqi.Model.Admin> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<shaoqi.Model.Admin> DataTableToList(DataTable dt)
        {
            List<shaoqi.Model.Admin> modelList = new List<shaoqi.Model.Admin>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                shaoqi.Model.Admin model;
