	...
	<div class="loginbox registbox">
		<div class="login-content reg-content">
			...
			<div class="row">
				...
				<input type="text" value="<%: phone%>" class="input-text-user noPic input-click" name="contact" id="contact">
			</div>
			<div class="row">
				<label class="field" for="company">邮箱</label>
				<input type="text" value="<%:email %>" class="input-text-user noPic input-click" name="company" id="company">
			</div>
