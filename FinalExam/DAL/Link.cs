...
namespace shaoqi.DAL
{
    ...
    public partial class Link
    {
        ...
        public shaoqi.Model.Link GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,linkTile,uRl from Link ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
            ...
            shaoqi.Model.Link model = new shaoqi.Model.Link();
        ...
        /// 得到一个对象实体
        /// </summary>
        public shaoqi.Model.Link DataRowToModel(DataRow row)
        {
            shaoqi.Model.Link model = new shaoqi.Model.Link();
            if (row != null)
            {
                ...
                if (row["linkTile"] != null)
                {
                    model.linkTile = row["linkTile"].ToString();
                }
                if (row["uRl"] != null)
                {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,linkTile,uRl ");
