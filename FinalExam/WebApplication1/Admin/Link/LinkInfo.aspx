<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinkInfo.aspx.cs" Inherits="WebApplication1.Admin.Link.LinkInfo" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#User').datagrid({
                ...
                fitColumns: true,
                idField: 'Id',
                url: '/Admin/Link/GetLinkInfo.ashx',
                loadMsg: '正在加载菜单的信息...',
                pagination: true,
                singleSelect: false,
                pageSize: 10,
                ...
                columns: [[
					...
					{ field: 'linkTile', title: '链接标题', width: 60 },
                    { field: 'uRl', title: '地址', width: 60 },
                    {
                        field: 'SubBy', title: '修改', width: 120,
                        formatter: function (value, row, index) {
                            return "<a  href='/Admin/Link/AddLink.aspx?id=" + row.id + "'>修改</a>";
                ...
                toolbar: [{
                    ...
                    iconCls: 'icon-add',
                    handler: function () {
                        window.location.href = "/Admin/Link/AddLink.aspx?action=Add";
                    }
                }, {
                    id: 'btncut',
                    text: '删除',
        ...
        function edit() {
            ...
            if (rows.length != 1) {
                ...
                var id = rows[0].Id;
                window.location.href = "/Admin/Link/AddLink.aspx?id=" + id;
            }
        }
        function Delete() {
            var ids = [];
            ...
            if (rows.length <= 0) {
                ...
                ids = ids.join(':');
                //将这个数异步传到一个ashx的处理
                $.post("/Admin/Link/DeleteLink.ashx", { "ids": ids }, function (data) {
                    if (data == "OK") {
